package com.lcmf.xll.recyclerviewdemo.DeskAssist.widgets;
...
public class AssistView extends View{
	...
	public AssistView(Context context, ServiceListener listener) {
		super(context);
		mContext = context;
	...
	private void initEasyTouchViewEvent() {
		...
		mWMParams = wmParams;
		wmParams.type = LayoutParams.TYPE_PHONE; // ÕâÀïµÄ2002±íÊ¾ÏµÍ³¼¶´°¿Ú£¬ÄãÒ²¿ÉÒÔÊÔÊÔ2003¡£
